 ...
 * @author Carlos
 */
public class GUIProfileView_text implements ProfileView {
     ...
     */
    public GUIProfileView_text(ProfileController profileController) {
    ...
    * Permite cambiar el status
    ...
    /*
     * Sirve para seleccionar el elemento que el usuario quiera   
     */
    ...
    * Añade un like a la publicación
    ...
    /*
     * Muestra la biografía de un perfil
     */
    ...
    /*
    * Procesa la solicitud de amistad
     */
...
/*
    ...
    */
    ...
    public void showCannotLikeOwnPostMessage() {
          JOptionPane.showMessageDialog(null, "No puedes dar like a tu propio mensaje.");
    }
    ...
    public void showAlreadyLikedPostMessage() {
         JOptionPane.showMessageDialog(null, "A este post ya le has dado me gusta.");
    ...
    public void showIsAlreadyFriendMessage(String profileName) {
        JOptionPane.showMessageDialog(null,profileName + " ya es tu amigo.");
    ...
    public void showExistsFriendshipRequestMessage(String profileName) {
         JOptionPane.showMessageDialog(null,"ya tiene una solicitud de amistad contigo. " + profileName);
    }
    ...
    public void showProfileMenu(Profile profile) {
        ...
        System.out.println("VERSION GUI. \n 1. Escribir una nueva publicacion");
